...
- GUI! (No, not TUI, but a proper GUI)
...
Basic install (Not done yet haha)

Basic usage example! (Not done yet haha)

For further documentation on the use of the project please refer to Documentation for users

## Technical

Compiling from source (Not done yet haha)

For further technical documentation please refer to Documentation for developers
